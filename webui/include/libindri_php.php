...
class SimpleQueryRunner {
	...
	public function __construct($qe) {
		if (is_resource($qe) && get_resource_type($qe) === '_p_SimpleQueryRunner') {
			$this->_cPtr=$qe;
			return;
		}
		$this->_cPtr=new_SimpleQueryRunner($qe);
	}

	public function getSnippet($i) {
		return SimpleQueryRunner_getSnippet($this->_cPtr,$i);
	}

	public function getMetaData() {
		return SimpleQueryRunner_getMetaData($this->_cPtr);
	}
	...
	public function getDocId($i) {
		return SimpleQueryRunner_getDocId($this->_cPtr,$i);
	}
}
